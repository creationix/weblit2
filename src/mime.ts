// A file extension to mime type mapping.
...
/**
 * Given a filename/path guess the mime type.
 * @param path filepath or filename including extension.
 * @param isText optional function that returns true if the file contains text.  Called on-demand.
 * @returns mimetype
 */
export function guess(path: string, isText?: () => boolean): string {
